...
Dégagez le terrain pour pouvoir atterrir sans obstacle. C'est le principe de Blufo.

Dans ce jeu vous pilotez un ovni et devez détruire les caisses posées sur votre zone d'atterrissage. Un seul missile à la fois mais ils sont très efficaces quand on vise correctement.

Ce jeu vidéo est développé en Delphi. Il fonctionne sous Windows, macOS, iOS et Android. [Téléchargez le pour y jouer](https://blufo.gamolf.fr) et le tester avant de regarder l'envers du décor et vous plonger dans ses codes sources.

Ce dépôt de code contient un projet développé en langage Pascal Objet sous Delphi. Vous ne savez pas ce qu'est Dephi ni où le télécharger ? Vous en saurez plus [sur ce site web](https://delphi-resources.developpeur-pascal.fr/).

## Utiliser ce jeu vidéo

Consultez [le site de Blufo](https://blufo.gamolf.fr) pour télécharger sa version compilée, en savoir plus sur son fonctionnement, accéder à des vidéos et articles, connaître les différentes versions disponibles et leurs fonctionnalités, contacter le support utilisateurs...
...
Pour télécharger ce dépôt de code il est recommandé de passer par "git" mais vous pouvez aussi télécharger un ZIP directement depuis [son dépôt GitHub](https://github.com/DeveloppeurPascal/Blufo).
...
L'export de la documentation est fait en HTML par [DocInsight](https://devjetsoftware.com/products/documentation-insight/) ou [PasDoc](https://pasdoc.github.io) vers le dossier /docs du dépôt. Vous y avez aussi [accès en ligne](https://developpeurpascal.github.io/Blufo) grâce à l'hébergement offert par GitHub Pages.

D'autres informations (tutoriels, articles, vidéos, FAQ, présentations et liens) sont disponibles sur [le site web du projet](https://blufo.gamolf.fr) ou [le devlog du projet](https://developpeur-pascal.fr/blufo.html).
...
Si vous détectez des anomalies sur des versions antérieures n'hésitez pas à [les rapporter](https://github.com/DeveloppeurPascal/Blufo/issues) pour que je teste et tente de corriger ou fournir un contournement.
...
Si vous voulez une réponse du propriétaire de ce dépôt la meilleure façon de procéder pour demander une nouvelle fonctionnalité ou signaler une anomalie est d'aller sur [le dépôt de code sur GitHub](https://github.com/DeveloppeurPascal/Blufo) et [d'ouvrir un ticket](https://github.com/DeveloppeurPascal/Blufo/issues).
